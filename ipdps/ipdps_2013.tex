...
%   \centering
%     \subfigure[Local connectivity graph]{
%       \includegraphics[width=0.23\linewidth]{combustion.png}
%       \label{fig:create}
%     }
%     \subfigure[Centralized merge with host]{
%       \includegraphics[width=0.23\linewidth]{figure5.png}
%       \label{fig:host}
%     }    
%     \subfigure[Centralized merge without host]{
%       \includegraphics[width=0.23\linewidth]{figure6.png}
%       \label{fig:centralized}
%     }
%     \subfigure[Decentralized merge]{
%       \includegraphics[width=0.23\linewidth]{figure7.png}
%       \label{fig:decentralized}
%     }
%   \caption[Optional caption for list of figures]{Caption of subfigures \subref{fig:create}, \subref{fig:centralized} and \subref{fig:decentralized}}
% \end{figure*}
...
1. Time to extract the features;

Since we use the region-growing based algorithm to extract features, the computation time is mainly depending on the scale of the volume, as well as the number of processors used for processing. Once the raw volume data and how it is partitioned, a.k.a. the scale of each data block is determined, the computation time for extracting residing feature remains approximately the same. For \textcolor{red}{pre-generated} data set, the size of each data block decrease as the number of processors increases and hence the amount of time spent on extracting features decreases accordingly.
...
2. Time to create / update local connectivity graph;

Despite the size of each data block, the computational cost for creating and updating local connectivity graph is largely depending on the number of the features extracted within the original volume, or more precisely, the number of features that touches the boundary surface of their residing data block. Similar to the computation time for extracting features, for \textcolor{red}{pre-generated} data set, the number of feature on boundary will decrease as the number of processors increases, and so does the computational time to create and update the local connectivity graph.
...
3. Time to merge to obtain all necessary connectivity information.
Last but not least, the three merging strategies explain in part III are the major factor of the scalability of our feature tracking algorithm. 

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.45\linewidth]{figure5.png}
	\includegraphics[width=0.45\linewidth]{figure5.png}
	\caption{TODO: processor level region growing}
	\label{fig:create-local-graph}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.45\linewidth]{figure6.png}
	\includegraphics[width=0.45\linewidth]{figure6.png}
	\caption{TODO: processor level region growing}
	\label{fig:create-local-graph}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.45\linewidth]{figure7.png}
	\includegraphics[width=0.45\linewidth]{figure7.png}
	\caption{TODO: processor level region growing}
	\label{fig:create-local-graph}
\end{figure}
