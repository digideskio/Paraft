...
\begin{figure}[ht]
	...
	\caption{Total computation time for the decentralized global merging strategy, scaled up to 2048 processors while the time for global merging outweighs the time used for feature extraction and when using more processors}
...
\begin{figure}[ht]
	...
	\caption{Total computation time for the decentralized local merging strategy, log-linearly scalable as the number of processor increases up to 16384 processors and the portion for local merging starts to increase when using more processors}
